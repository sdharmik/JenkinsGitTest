...
public void initialize() throws Exception{
	...
	if(!isInitialized){
		...
		fis = new FileInputStream(System.getProperty("user.dir")+"\\src\\com\\core\\config\\config.properties");
		p.load(fis);
		...
		AppLogs.debug("Loading individual test case excel file");
		loginExcel = new ReadExcel(System.getProperty("user.dir")+"\\src\\com\\core\\data\\TC_001.xls");
		AppLogs.debug("File loaded successfully");
		isInitialized=true;
	}
}
